...
class ProvincesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create province" do
    assert_difference("Province.count") do
      post provinces_url, params: { province: { code: @province.code, name: @province.name, slug: @province.slug } }
    end
  ...
  test "should update province" do
    patch province_url(@province), params: { province: { code: @province.code, name: @province.name, slug: @province.slug } }
