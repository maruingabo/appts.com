...
class ResultsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create result" do
    assert_difference("Result.count") do
      post results_url, params: { result: { description: @result.description, name: @result.name } }
    end
  ...
  test "should update result" do
    patch result_url(@result), params: { result: { description: @result.description, name: @result.name } }
