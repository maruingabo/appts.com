...
class EstablishmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create establishment" do
    assert_difference("Establishment.count") do
      post establishments_url, params: { establishment: { address: @establishment.address, booking_offset: @establishment.booking_offset, city_id: @establishment.city_id, domain: @establishment.domain, name: @establishment.name, phone_number: @establishment.phone_number, status: @establishment.status, subdomain: @establishment.subdomain } }
    end
  ...
  test "should update establishment" do
    patch establishment_url(@establishment), params: { establishment: { address: @establishment.address, booking_offset: @establishment.booking_offset, city_id: @establishment.city_id, domain: @establishment.domain, name: @establishment.name, phone_number: @establishment.phone_number, status: @establishment.status, subdomain: @establishment.subdomain } }
